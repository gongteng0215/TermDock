...
1. `P1-J1/J2/J3`：服务器监控增强（告警阈值、服务/进程下钻、历史时间窗）
...
| P1-H6 | PARTIAL | 已有服务器基础监控，待补 RTT/重连次数/失败率与告警策略 |
...
| ID | 状态 | 说明 |
| --- | --- | --- |
| P1-J1 | BACKLOG | 监控阈值告警（CPU/内存/磁盘）+ 角标/提示 |
| P1-J2 | BACKLOG | 服务与进程下钻（`systemctl` 状态、Top N 进程） |
